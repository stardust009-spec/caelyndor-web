...
// Forma autoral canónica para SEO/JSON-LD (author, creator, name de la entidad
// autoral). Coincide con el crédito visible del footer.
export const SITE_AUTHOR = "Claudio F. Barriga A.";
// Otras identidades del autor (nombre corto y handles públicos) como alias para
// consolidar la entidad en buscadores y vincular sus perfiles externos; no son
// la forma principal, pero se conservan por su función de marca/perfil.
export const SITE_AUTHOR_ALIASES = ["Claudio", "Stardust Claudio", "Athem 009"];
